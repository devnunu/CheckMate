    ...
    def minimize_previous_comments(self):
        ...
        for comment in comments:
            ...
            if (comment.user.login == 'github-actions[bot]' and
                ...
                # GitHub API로 코멘트 minimize (실제로는 숨김 처리)
                # 참고: 이 기능은 GitHub의 GraphQL API를 사용해야 정확히 구현 가능
                # 현재는 간단히 편집으로 처리
                try:
